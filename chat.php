...
///
if ($row["level"]<4&&$rm==18&&$row["posts"]>100) {
if ($ver=="wml"){
echo $xml;
echo $dtd;
echo "<wml>";
...
else if($row["level"]>7&&$rm==7){$keykey=1;}
...
if ($rm == 1) require("ludak1.php");
if ($rm == 5) require("anagram1.php");
if($rm==13) {require("vesala1.php");}
if($ver=="xhtml"){
$msg=check($_POST["$ssseee"]);
}
if(@$msg){
$msg = trim(" $msg ");
...
if ($row["level"]<5) {require("antireklx.php");}
//require("smile.php");
//unset($smiles);
//unset($replaces);
if($row["level"]>6)
...
if(!empty($boja)){
if (($boja==1)) $msg = '<font color=\"#FFFFFF\">'.$msg.'</font>';
else if (($row["level"]>=0) && ($boja==2)) $msg = '<font color=\"#0000FF\">'.$msg.'</font>';
else if (($row["level"]>=0) && ($boja==3)) $msg = '<font color=\"#FF0000\">'.$msg.'</font>';
else if (($row["level"]>=0) && ($boja==4)) $msg = '<font color=\"#FFFF00\">'.$msg.'</font>';
else if (($row["level"]>=0) && ($boja==5)) $msg = '<font color=\"#FF00FF\">'.$msg.'</font>';
else if (($row["level"]>=0) && ($boja==6)) $msg = '<font color=\"#BA55D3\">'.$msg.'</font>';
}
...
//echo "<do type=\"options\" name=\"add\" label=\"Napishi\"><go href=\"chat.php?$ses&amp;rm=$rm$takep#add\"/></do>";
}else{
//echo "<do type=\"options\" name=\"add\" label=\"Napishi\"><go href=\"#add\"/></do>";
}
}
...
if (($row["kn_sos"]==0)&&($rm!=11)&&($rm!=10)&&($row["level"]<4))echo "<do type=\"options\" name=\"help\" label=\"Pozovi Moda\"><go href=\"sos.php?$ses&amp;rm=$rm$takep\"/></do>";
...
if($ispis!="") echo "<b><small>".$ispis."</small></b><br/>";
///FORUM POST
...
echo "<small>&#171; <a href=\"forum.php?$ses&amp;ref=$ref&amp;action=topic&amp;tid=$lpt[0]&amp;page=$num_pages\">$lpt[2]</a></small>";
echo "<small> - <a href=\"info.php?$ses&amp;ref=$ref&amp;nk=$tluid\">$pos4[0]</a> &#187; <br/></small>";
      }
////FORUM POST	

if ($rm==7) 
{
echo "[ <a href=\"ucinak.php?$ses&amp;ref=$ref&amp;rm=$rm\">UCINAK</a> ]<br/>";
}
echo $fsize1;
if($inb != "0") echo "<img src=\"images/new.gif\" alt=\"NEW\"/><b>Inbox<a href=\"inbox.php?$ses&amp;rm=$rm&amp;ref=$ref&amp;pwd=$pwd\">(".$inb.")</a></b><br/>\n";
if ($ver=="wml"){
...
echo "<a href=\"chat.php?$ses&amp;rm=$rm$takep#add\" accesskey=\"$bind1\">Napishi</a>|";
$manje = time()-600;
...
echo "<a href=\"#add\" accesskey=\"$bind1\">Napishi</a>|";
...
$manje = time()-600;
$gdeko = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE gdetime> '".$manje."'"));
echo "<a href=\"add.php?$ses&amp;rm=$rm$takep\" accesskey=\"$bind1\">Napishi </a>|<a href=\"who.php?$ses&amp;ref=$ref\"> Ko je gde(".$gdeko[0].") </a>|<a href=\"chat.php?$ses&amp;rm=$rm$takep\" accesskey=\"$bind2\"> Osvezi </a>|<a href=\"function.php?$ses&amp;rm=$rm$takep\" accesskey=\"3\"> Funkcije</a>|<a href=\"enter.php?$ses&amp;ref=$ref\">Hodnik</a>";    
echo "</div>";
...
if ($newtod[0]>0){ 
$novi = mysql_fetch_array(mysql_query("select id,user from users where valid=0 AND id>'8' order by id asc limit 0,1"));
echo "<br/>[ <a href=\"info.php?$ses&amp;nk=$novi[0]&amp;ref=$ref\">".$novi[1]."</a>"; 
echo "<a href=\"apanel.php?$ses&amp;to=$novi[0]&amp;go=valid$takep\">[+]</a> ";
echo "<a href=\"apanel.php?$ses&amp;to=$novi[0]&amp;go=valid1$takep\">[-]</a> ]<br/>\n";
}
}
...
if ($row["level"]<5){
if ($ver=="wml"){
if($rm!="15") {echo "<br/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".$name."</a></b>".$komu."(".$date.")\n".$msg.""; $mread++;
}else
echo "<br/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".$name."</a></b>".$komu."(".$date.")\n".$msg.""; $mread++;
}else{
/* $obojeno=mysql_fetch_array(mysql_query("SELECT color FROM users WHERE id='".$usid."'")); */
if ($sex=="M") {echo "<br/><img src=\"smile/pol_m.gif\" alt=\"&#1052;\"/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".col_n($name)."</a></b>".$komu."(".$date.")\n".$msg.""; $mread++;}
else {echo "<br/><img src=\"smile/pol_j.gif\" alt=\"Z\"/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".col_n($name)."</a></b>".$komu."(".$date.")\n".$msg.""; $mread++;}
}
}else{
if ($ver=="wml"){
if($rm!="15") {echo "<br/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".$name."</a>".$komu."</b>(".$date.")";
}else
...
else if (($th == $id)||($id == $usid)||($row["level"]>=8 && $pwtread[0]==1)){
if (!empty($komu)) {
if ($us==$komu) $komu = "-<b>".$komu."</b>";
else $komu = "-".$komu."";
}
if ($row["level"]<5){
if ($ver=="wml"){
if($rm!="15") {echo "<br/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".$name."</a></b>".$komu."(".$date.")<b>[P!]</b>\n".$msg.""; $mread++;
}else
echo "<br/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".$name."</a></b>".$komu."(".$date.")<b>[P!]</b>\n".$msg.""; $mread++;

}else{
$obojeno=mysql_fetch_array(mysql_query("SELECT color FROM users WHERE id='".$usid."'"));
if ($sex=="M") {echo "<br/><img src=\"smile/pol_m.gif\" alt=\"&#1052;\"/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".col_n($name)."</a></b>".$komu."(".$date.")<b>[P!]</b>\n".$msg.""; $mread++;}
else {echo "<br/><img src=\"smile/pol_j.gif\" alt=\"Z\"/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".col_n($name)."</a></b>".$komu."(".$date.")<b>[P!]</b>\n".$msg.""; $mread++;}
}
}else{
if ($ver=="wml"){
if($rm!="15") {echo "<br/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".$name."</a>".$komu."</b>(".$date.")<b>[P!]</b>";
}else
echo "<br/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".$name."</a>".$komu."</b>(".$date.")<b>[P!]</b>";

}else{
$obojeno=mysql_fetch_array(mysql_query("SELECT color FROM users WHERE id='".$usid."'"));
if ($sex=="M") {echo "<br/><img src=\"smile/pol_m.gif\" alt=\"&#1052;\"/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".col_n($name)."</a>".$komu."</b>(".$date.")<b>[P!]</b>";}
else {echo "<br/><img src=\"smile/pol_j.gif\" alt=\"Z\"/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".col_n($name)."</a>".$komu."</b>(".$date.")<b>[P!]</b>";}
}
echo "<a href=\"delmess.php?$ses&amp;rm=$rm&amp;klu4=$klu4$takep\">[X]</a>\n".$msg.""; $mread++;
}
}
...
$hid = $lines["hid"];
@mysql_query ("Select * from ignor where usid='".$usid."' and id='".$id."'");
if ((mysql_affected_rows() == false)&&(($hid != 2)||($id == $usid)||($row["level"]>=8 && $pwtread[0]==1))){
$pols = @mysql_query ("SELECT sex,color FROM users where user='".$name."'");
$zs1 = @mysql_fetch_array ($pols);
$sex = $zs1["sex"];
$napisao=mysql_fetch_array(mysql_query("SELECT user, color FROM users WHERE id='".$id."'"));
if ($th == ""){
if (!empty($komu)) {
if ($us==$komu) $komu = "-<b>".$komu."</b>";
else $komu = "-".$komu."";
...
if ($row["level"]<5){
if ($ver=="wml"){
if($rm!="15") {echo "<br/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;rm=$rm&amp;nk=$usid$takep\">".$name."</a></b>".$komu."(".$date.")\n".$msg."";$mread++;
}else
echo "<br/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".$name."</a></b>".$komu."(".$date.")\n".$msg."";$mread++;
...
if (($th == $id)||($id == $usid)||($row["level"]>=8 && $pwtread[0]==1)){
if (!empty($komu)) {
if ($us==$komu) $komu = "-<b>".$komu."</b>";
else $komu = "-".$komu."";
}
...
$obojeno=mysql_fetch_array(mysql_query("SELECT color FROM users WHERE id='".$usid."'"));
if ($sex=="M") {echo "<br/><img src=\"smile/pol_m.gif\" alt=\"&#1052;\"/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".col_n($name)."</a>".$komu."</b>(".$date.")<b>[P!]</b>";}
else {echo "<br/><img src=\"smile/pol_j.gif\" alt=\"Ž\"/><b><a href=\"info.php?$ses&amp;rm=$rm&amp;nk=$usid$takep\">".col_n($name)."</a>".$komu."</b>(".$date.")<b>[P!]</b>";}
}
echo "<a href=\"delmess.php?$ses&amp;rm=$rm&amp;klu4=$klu4$takep\">[X]</a>\n".$msg."";$mread++;
}
}
...
$page_next = $max;
if ($ver=="wml") echo "<br/>---<br/><a href=\"enter.php?$ses&amp;ref=$ref\"> Hodnik </a>|";
else echo "<br/><br/>";
if ($max < $total){
...
if($rm!=10){
if ($ver=="wml") {echo "<a href=\"smilies.php?$ses&amp;rm=$rm$takep\">Smajliji </a>|<a href=\"color.php?$ses&amp;rm=$rm$takep\">Boja nika </a>|<a href=\"whoroom.php?$ses&amp;rm=$rm$takep\"> Ko je tu</a>";
$tm = time()-600;
...
echo "<div class=\"d1\">";
echo $fsize1;
echo "<a href=\"smilies.php?$ses&amp;rm=$rm$takep\">Smajliji </a>|<a href=\"color.php?$ses&amp;rm=$rm$takep\">Boja nika </a>|<a href=\"statistik.php?$ses&amp;ref=$ref\"> Statistika </a>|<a href=\"enter.php?$ses&amp;ref=$ref\" accesskey=\"$bind4\"> Hodnik </a>|<a href=\"whoroom.php?$ses&amp;rm=$rm$takep\"> Ko je tu</a>";
$tm = time()-600;
$sobe = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE gdetime>'".$tm."' AND gde='".$room."'"));
echo "<b><a href=\"chat.php?$ses&amp;rm=$rm&amp;ref=$ref\">$roomname ($sobe[0])</a></b><br/>";
echo $fsize2;
...
if ($ver=="wml"){
echo "<card id=\"add\" title=\"Napishi\">";
echo "<p>";
echo $fsize1;
echo "Tekst:<br/>\n";
echo $fsize2;
...
echo "Boja:<br/>\n";
echo $fsize2;
echo "<select name=\"boja\">\n";
echo "<option value=\"0\">Normalno</option>\n";
echo "<option value=\"1\">Belo</option>\n";
echo "<option value=\"2\">Plavo</option>\n";
echo "<option value=\"3\">Crveno</option>\n";
echo "<option value=\"4\">Zuto</option>\n";
echo "<option value=\"5\">Pink</option>\n";
echo "<option value=\"6\">Ljubicasto</option>\n";
echo "</select><br/>\n";
}
echo $fsize1;
echo "<anchor title=\"send\">Napishi<go href=\"chat.php?$ses&amp;rm=$rm$takep\" method=\"post\">";
...
$a = mysql_fetch_array($r);
$sm = $a["sm"];  
mysql_query ("select * from $ringame WHERE role = 'Glavni mafijas'");
if (mysql_affected_rows()==0&&$sm!=0){
$r = mysql_query ("select * from $ringame WHERE role = 'Mafijas'");
if (mysql_affected_rows()==0){ 
$vktr = true;
...
$role = $a["role"];
$gamer_id = $a["gamer_id"];
if ($role == "Pijandura") mysql_query("update users set creditsingame = creditsingame + 100 WHERE id = '".$gamer_id."'"); 
...
mysql_query ("update $ringame set role = 'Glavni mafijas' WHERE id_in_game = '".$id_in_game."'");
...
$a = mysql_fetch_array($r); 
if ($a["sm"]==2){
mysql_query("select * from $ringame WHERE (role = 'Glavni mafijas')or(role = 'Mafijas')"); 
if (mysql_affected_rows()==2) $vk = "maf";
if (mysql_affected_rows()==1){
mysql_query("select * from $ringame WHERE (role = 'Doktor')or(role = 'Komesara Katani')or(role = 'Ludak')or(role = 'Manijak')");   
...
$r = mysql_query("Select count(*) as sm from $ringame WHERE (role='Mafijas')or(role='Glavni mafijas')");
$a = mysql_fetch_array($r);
$sm = $a["sm"];
if ($sm>$nm) $vk = "maf";
if (isset($vk)){ 
...
$role = $a["role"];
$gamer_id = $a["gamer_id"];
if ($role == "Mafijas"||$role == "Glavni mafijas") 
...
mysql_query ("Insert into $room set klu4= '".$rnd."', time='".$today."', who='".$mafiozi."', usid = '".$mafid."', message='".$mmsg."', id='".$tm."', towhom='', gamemes='1', komu=''"); 
mysql_query ("Update users set posts = posts + 1 WHERE id = '".$mafid."'");           
mysql_query("select gamer_id from $ringame WHERE role = 'Komesara Katani'");
if(mysql_affected_rows()==0){ 
$r = mysql_query("select state from $ringame WHERE role = 'Zena Komesara'");      
if (mysql_affected_rows()!=0){ 
$a = mysql_fetch_array($r);
if ($a["state"]==0) mysql_query ("update $ringame set state = '1' WHERE role = 'Zena komesara'");
}
}
...
$re = mysql_query("select * from $ringame WHERE ((role = 'Mafijas')or(role = 'Glavni mafijas'))and(gamer_id != '".$thg."')");
$so = "";
while (($b = mysql_fetch_array($re))!==false){
$sname = get_name_by_id($b["id_in_game"], $rm);
if (get_role_by_id($b["id_in_game"], $rm)!="Glavni mafijas") $so = $so."$sname, "; else $so = $so."$sname(glavni), ";
}    
...
$r = mysql_query("select * from $ringame WHERE role = 'Glavni mafijas'");
$a = mysql_fetch_array($r);
$glmaf_id = $a["gamer_id"];             
...
$r = mysql_query("select * from $ringame WHERE role = 'Komesar Katani'"); 
if (mysql_affected_rows()!=0){
$a = mysql_fetch_array($r);
$kom_id = $a["gamer_id"];
...
$r = mysql_query("select * from $ringame WHERE role = 'Manijak'"); 
if (mysql_affected_rows()!=0){
$a = mysql_fetch_array($r);
$man_id = $a["gamer_id"];
...
$r = mysql_query("select * from $ringame WHERE role = 'Skitnica'");  
if (mysql_affected_rows()!=0){
$a = mysql_fetch_array($r);
$put_id = $a["gamer_id"];
...
$r = mysql_query("select * from $ringame WHERE role = 'Prosjak'"); 
if (mysql_affected_rows()!=0){
$a = mysql_fetch_array($r);
$bomj_id = $a["gamer_id"];
...
$r = mysql_query("select * from $ringame WHERE role = 'Doktor'");
if (mysql_affected_rows()!=0){ 
$a = mysql_fetch_array($r);
$dok_id = $a["gamer_id"];
...
$r = mysql_query("select * from $ringame WHERE role = 'Klovan'"); 
$a = mysql_fetch_array($r);
$state = $a["state"];
...
$r = mysql_query("select * from $ringame WHERE role = 'Zena komesara'"); 
$a = mysql_fetch_array($r);
$state = $a["state"];
...
$put_act = $a["gamer_act"];
$put_id = $a["gamer_id"]; 
$r = mysql_query("select * from $ringame WHERE role = 'Gorstak'");
$a = mysql_fetch_array($r);
...
if (get_role_by_id($a["gamer_act"], $rm)=="Mafijas"||get_role_by_id($a["gamer_act"], $rm)=="Glavni mafijas")$tokom = "$wh - mafija"; 
...
if (get_role_by_id($a["gamer_act"], $rm)=="Mafijas"||get_role_by_id($a["gamer_act"], $rm)=="Glavni mafijas") {$mmsg = $mmsg." Nakon slozene operacije Inspektor je ubio $kto $wh!!!"; mysql_query("update users set creditsingame = creditsingame + 20 WHERE id = '".$kom_id."'");}
...
if ($dok_act != $a["gamer_act"]){  
mysql_query("select * from $ringame WHERE (id_in_game = '".$man_act."')and((role = 'Mafijas')or(role = 'Glavni mafijas'))");
...
mysql_query("update $ringame set state = '1' WHERE role = 'Klovan'");
}
} 
}      
$tm = getmicrotime();
...
$role = $a["role"];
$gamer_id = $a["gamer_id"];
if ($role == "Seljak") mysql_query("update users set creditsingame = creditsingame + 100 WHERE id = '".$gamer_id."'"); 
else mysql_query("update users set creditsingame = creditsingame + 50 WHERE id = '".$gamer_id."'");
}
...
if (mysql_affected_rows()==2) $vk = "maf";
if (mysql_affected_rows()==1){ 
mysql_query("select * from $ringame WHERE (role = 'Doktor')or(role = 'Komesar Katani')or(role = 'Skitnica')or(role = 'Manijak')");   
...
$role = $a["role"];
$gamer_id = $a["gamer_id"];
if ($role == "Mafijas"||$role == "Glavni mafijas") mysql_query("update users set creditsingame = creditsingame + 50 WHERE id = '".$gamer_id."'"); 
}
...
$r = mysql_query ("select * from $ringame");
$roles = array("Seljak","Glavni mafijas","Komesar Katani"); 
if (mysql_affected_rows()>3) array_push ($roles,"Doktor");
if (mysql_affected_rows()>4) array_push ($roles,"Seljak");
if (mysql_affected_rows()>5) array_push ($roles,"Mafijas");
if (mysql_affected_rows()>6) array_push ($roles,"Manijak");
if (mysql_affected_rows()>7) array_push ($roles,"Skitnica");
if (mysql_affected_rows()>8) array_push ($roles,"Seljak");
if (mysql_affected_rows()>9) array_push ($roles,"Mafijas");
if (mysql_affected_rows()>10) array_push ($roles,"Prosjak");   
if (mysql_affected_rows()>11) array_push ($roles,"Mafijas"); 
if (mysql_affected_rows()>12) array_push ($roles,"Gorstak"); 
if (mysql_affected_rows()>13) array_push ($roles,"Klovan");  
if (mysql_affected_rows()>14) array_push ($roles,"Mafijas"); 
if (mysql_affected_rows()>15) array_push ($roles,"Zena komesara");
for ($i=1;$i<=((mysql_affected_rows()-15)/3);$i++) array_push ($roles,"Mafijas");     
$j = count ($roles);
for ($i=1;$i<=mysql_affected_rows()-$j;$i++) array_push ($roles,"Seljak");
...
if ($gmes==1&&$action == "dvote"&&($msg == "!da"||$msg == "!ne"||$msg == "!&#1076;&#1072;"||$msg == "!Ne")){
...
if ($krole=="Mafijas"||$krole=="Glavni mafijas"){        
...
$state = $a["state"];
if ($role!="Seljak"&&$role!="Mafijas"&&$role!="Klovan"&&$role!="Zena komesara"){
$s = str_replace("!","",$msg);
...
if ($role == "Komesar Katani"&&strpos($msg,"!!")!==false) {
$mmsg = "Naruceno ubistvo za $gname je prihvaceno!";
$s="!".$s;
$rnd = rand(1,3); 
...
}else if ($role=="Zena komesara"&&$state==1){ 
$s = str_replace("!","",$msg);
$r = mysql_query("select * from $ringame WHERE id_in_game = '".$s."'");
if (mysql_affected_rows()!=0){   
...
$r = mysql_query ("select count(*) as nv from $ringame WHERE (role != 'Seljak')and(gamer_act='')");  
$a = mysql_fetch_array($r);
if ($a["nv"]==0){  
...
if ($action == "nogame"&&($msg=="!start"||$msg=="!start")){
$tm = time()+180;
...
if ($action == "registration"&&($msg=="!reg"||$msg=="!reg")){ 
mysql_query ("select * from $ringame WHERE gamer_id = '".$id."'");
if (mysql_affected_rows()==0){
...
echo "<div class=\"d1\">";
echo $fsize1;
echo "<a href=\"add.php?$ses&amp;rm=$rm$takep\" accesskey=\"$bind1\">Napishi</a>|<a href=\"who.php?$ses&amp;rm=$rm&amp;ref=$ref\">Ko je gde?</a>";
echo $fsize2;
echo "</div>";
echo $fsize1;
}
...
echo "<br/><b><a href=\"info.php?$ses&amp;nk=$usid&amp;rm=$rm&amp;ref=$ref\">".$name."</a></b>".$komu."(".$date.")<b>[P!]</b>\n".$msg."";$mread++;
}
}    
}
...
echo $fsize1;
echo "<anchor title=\"send\">Napishi<go href=\"chat.php?$ses&amp;rm=$rm&amp;ref=$ref\" method=\"post\">\n";
echo "<postfield name=\"msg\" value=\"$(msg$ref)\"/>\n";
echo "<postfield name=\"shrift\" value=\"$(shrift$ref)\"/>\n";
echo "<postfield name=\"boja\" value=\"$(boja$ref)\"/>\n";
echo "</go></anchor>\n";
echo $fsize2;
echo "<br/>\n";
echo $fsize1;
